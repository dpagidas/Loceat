...
public class Location {
     ...
     * @param lat
     */
    public Location(String address, Double lat, Double lng, List<LabeledLatLng> labeledLatLngs, Integer distance, String postalCode, String cc, String city, String state, String country, List<String> formattedAddress) {
        super();
